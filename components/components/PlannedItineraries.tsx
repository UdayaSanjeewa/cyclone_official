    ...
    <section className="w-full py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
              ...
              >
                <Card className="group h-[480px] flex flex-col overflow-hidden rounded-2xl border-none shadow-md transition-all duration-300 hover:shadow-xl">
                  ...
                  <CardContent className="pt-0 text-center mt-auto pb-6">
                    <Link href={"/itineraries/enchanting-sri-lanka"}>
        ...
        <div className="text-center mt-28">
          <p className="text-lg mb-2">Looking for an</p>
          <h3 className="text-3xl md:text-4xl font-serif mb-3">
            Exclusive Customized Tour?
          </h3>
          <p className="mb-10">No Problem</p>

          <button className="inline-flex items-center gap-2 px-10 py-3 rounded-full bg-pink-600 text-white text-sm font-semibold shadow-md hover:bg-pink-700 hover:shadow-lg transition">
            CONNECT WITH US
            <span>→</span>
          </button>
        </div>
