...
function OwnersSection() {
  return (
    <section className="relative flex flex-col items-center justify-center py-12 md:py-16 lg:py-20 bg-gradient-to-br from-[#f5f7fa] to-[#e4ebf5] overflow-hidden">
      {/* Decorative Background Blur */}
      <div className="absolute top-0 left-0 w-[150px] md:w-[200px] h-[150px] md:h-[200px] bg-[#00329533] rounded-full blur-3xl"></div>
      <div className="absolute bottom-0 right-0 w-[150px] md:w-[200px] h-[150px] md:h-[200px] bg-[#00194633] rounded-full blur-3xl"></div>

      {/* Section Title */}
      <h2 className="relative text-[26px] sm:text-[30px] md:text-[36px] lg:text-[42px] font-bold text-[#001946] mb-8 md:mb-12 tracking-wide text-center leading-tight px-4">
        Meet the <span className="text-[#003295]">Owners</span>
        <div className="w-16 md:w-20 h-[2px] bg-[#003295] mx-auto mt-3 rounded-full"></div>
      </h2>
      ...
      <div className="relative bg-white/80 backdrop-blur-md border border-[#00329522] shadow-2xl rounded-2xl px-4 sm:px-6 md:px-8 py-8 sm:py-10 flex flex-col md:flex-row justify-center gap-6 md:gap-10 hover:shadow-[#00329533] transition-all duration-500 xl:w-[650px] lg:w-[600px] w-[90%] max-w-[700px]">
        ...
        {/* Divider */}
        <div className="hidden md:block w-[1px] bg-gradient-to-b from-transparent via-[#00329522] to-transparent"></div>
